...
LineAnalyzerConfigXmlHandler::LineAnalyzerConfigXmlHandler() {
}

LineAnalyzerConfigXmlHandler::~LineAnalyzerConfigXmlHandler() {
}

wxXmlNode* LineAnalyzerConfigXmlHandler::CreateNode(
  ...
  node_root = new wxXmlNode(wxXML_ELEMENT_NODE, "line_analyzer_config");
...
bool LineAnalyzerConfigXmlHandler::ParseNode(const wxXmlNode* root,
...
bool LineAnalyzerConfigXmlHandler::ParseNodeV1(const wxXmlNode* root,
                                               const std::string& filepath,
                                               LineAnalyzerConfig& config) {
  bool status = true;
  wxString message;
