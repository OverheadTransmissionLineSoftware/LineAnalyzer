...
#ifndef OTLS_LINEANALYZER_LINEANALYZERFRAME_H_
#define OTLS_LINEANALYZER_LINEANALYZERFRAME_H_
...
class LineAnalyzerFrame : public wxDocParentFrame {
 public:
  /// \brief Constructor.
  LineAnalyzerFrame(wxDocManager* manager);

  /// \brief Destructor.
  virtual ~LineAnalyzerFrame();
...
#endif  // OTLS_LINEANALYZER_LINEANALYZERFRAME_H_
